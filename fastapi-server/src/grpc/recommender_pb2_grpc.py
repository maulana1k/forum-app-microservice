...
from src.grpc import recommender_pb2 as recommender__pb2
...
class RecommenderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetRecommendedPosts = channel.unary_unary(
            "/recommender.RecommenderService/GetRecommendedPosts",
...
class RecommenderServiceServicer(object):
    ...
    def GetRecommendedPosts(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_RecommenderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GetRecommendedPosts": grpc.unary_unary_rpc_method_handler(
            servicer.GetRecommendedPosts,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "recommender.RecommenderService", rpc_method_handlers
    )
